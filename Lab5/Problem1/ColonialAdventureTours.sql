...
CREATE TABLE IF NOT EXISTS "ENROLLMENT" (
	...
	PRIMARY KEY("CUSTOMER_NUM","CLASS_NUM","CLASS_DATE")
);
...
INSERT INTO "CUSTOMER" VALUES ('101','Northfold','Liam','9 Old Mill Rd.','Londonderry','NH','03053','603-555-7563',NULL);
INSERT INTO "CUSTOMER" VALUES ('102','Ocean','Arnold','2332 South St. Apt 3','Springfield','MA','01101','413-555-3212',NULL);
INSERT INTO "CUSTOMER" VALUES ('103','Kasuma','Sujata','132 Main St. #1','East Hartford','CT','06108','860-555-0703',NULL);
INSERT INTO "CUSTOMER" VALUES ('104','Goff','Ryan','164A South Bend Rd.','Lowell','MA','01854','781-555-8423',NULL);
INSERT INTO "CUSTOMER" VALUES ('105','McLean','Kyle','345 Lower Ave.','Wolcott','NY','14590','585-555-5321',NULL);
INSERT INTO "CUSTOMER" VALUES ('106','Morontoia','Joseph','156 Scholar St.','Johnston','RI','02919','401-555-4848',NULL);
INSERT INTO "CUSTOMER" VALUES ('107','Marchand','Quinn','76 Cross Rd.','Bath','NH','03740','603-555-0456',NULL);
INSERT INTO "CUSTOMER" VALUES ('108','Rulf','Uschi','32 Sheep Stop St.','Edinboro','PA','16412','814-555-5521',NULL);
INSERT INTO "CUSTOMER" VALUES ('109','Caron','Jean Luc','10 Greenfield St.','Rome','ME','04963','207-555-9643',NULL);
INSERT INTO "CUSTOMER" VALUES ('110','Bers','Martha','65 Granite St.','York','NY','14592','585-555-0111',NULL);
INSERT INTO "CUSTOMER" VALUES ('112','Jones','Laura','373 Highland Ave.','Somerville','MA','02143','857-555-6258',NULL);
INSERT INTO "CUSTOMER" VALUES ('115','Vaccari','Adam','1282 Ocean Walk','Ocean CITY','NJ','08226','609-555-5231',NULL);
INSERT INTO "CUSTOMER" VALUES ('116','Murakami','Iris','7 Cherry Blossom St.','Weymouth','MA','02188','617-555-6665',NULL);
INSERT INTO "CUSTOMER" VALUES ('119','Chau','Clement','18 Ark Ledge Ln.','Londonderry','VT','05148','802-555-3096',NULL);
INSERT INTO "CUSTOMER" VALUES ('120','Gernowski','Sadie','24 Stump Rd.','Athens','ME','04912','207-555-4507',NULL);
INSERT INTO "CUSTOMER" VALUES ('121','Bretton-Borak','Siam','10 Old Main St.','Cambridge','VT','05444','802-555-3443',NULL);
INSERT INTO "CUSTOMER" VALUES ('122','Hefferson','Orlagh','132 South St. Apt 27','Manchester','NH','03101','603-555-3476',NULL);
INSERT INTO "CUSTOMER" VALUES ('123','Barnett','Larry','25 Stag Rd.','Fairfield','CT','06824','860-555-9876',NULL);
INSERT INTO "CUSTOMER" VALUES ('124','Busa','Karen','12 Foster St.','South Windsor','CT','06074','857-555-5532',NULL);
INSERT INTO "CUSTOMER" VALUES ('125','Peterson','Becca','51 Fredrick St.','Albion','NY','14411','585-555-0900',NULL);
INSERT INTO "CUSTOMER" VALUES ('126','Brown','Brianne','154 Central St.','Vernon','CT','06066','860-555-3234',NULL);
