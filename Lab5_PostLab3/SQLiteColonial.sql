...
(CUSTOMER_NUM TEXT(4) PRIMARY KEY,
LAST_NAME TEXT(30) ,
FIRST_NAME CHAR (30),
ADDRESS TEXT(35),
CITY TEXT(35),
...
(RESERVATION_ID TEXT(7) PRIMARY KEY,
TRIP_ID REAL(3,0),
TRIP_TEXT TEXT,
NUM_PERSONS REAL(3,0),
TRIP_PRICE REAL(6,2),
OTHER_FEES REAL(6,2),
CUSTOMER_NUM TEXT(4) );
CREATE TABLE TRIP
(TRIP_ID REAL(3,0) PRIMARY KEY,
TRIP_NAME TEXT(75),
START_LOCATION TEXT(50),
STATE TEXT(2),
DISTANCE REAL(4,0),
MAX_GRP_SIZE REAL(4,0),
TYPE TEXT(20),
SEASON TEXT(20) );
